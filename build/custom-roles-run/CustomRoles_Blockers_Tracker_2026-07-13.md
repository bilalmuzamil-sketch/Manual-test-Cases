...
**Two-stage pass:** (1) build-accurate WORDING — all 252 core cases reworded + pushed to TestRail via `update_case` (200/200). (2) BEHAVIORAL VIU 2026-07-13 — role-editor SPA + downstream product screens driven headless via boot2 (assign Tech the role under test, quick-login, hydrate, observe; resource View/Create&Edit via endpoint 403/200). No TestRail writes in the behavioral pass.

**Tally (252 core cases):** VIU-Verified 138 · Blocked-UI 103 · Deviation/Finding 11.
...
## Still Blocked-UI — by section (deep per-role app-screen navigation / historical)

| Section | Area | Count | Cases |
|---|---|---:|---|
| 3528 | Roles List | 1 | C26317 |
| 3530 | Edit Role | 3 | C26346 C26347 C26349 |
...
| 3537 | Customer Management | 6 | C26399 C26400 C26401 C26402 C26403 C26405 |
| 3538 | Parts Department | 8 | C26410 C26411 C26412 C26414 C26415 C26417 C26418 C26419 |
...
| 3553 | Cross-Permission | 7 | C26540 C26541 C26544 C26545 C26548 C26549 C26550 |

## Resume conditions
- Cookies `/tmp/custom-roles/cookies-viu-0713.env`; boot2 tooling in `/tmp/custom-roles/beh0713/` (adm.mjs/boot2.mjs/drive.mjs/click.mjs/cascade.mjs/assign.mjs/setstatus.mjs).
...
- Parts routes: /parts/parts-catalogue, /parts/orders, /parts/part-sales (redirected for a partSalesView-only role — investigate), /parts/inventory. Enforcement model: resource View/Create&Edit -> endpoint 403 vs 200/201; Delete/sub-perms/view_mode/cross-toggles -> observe in hydrated UI.
