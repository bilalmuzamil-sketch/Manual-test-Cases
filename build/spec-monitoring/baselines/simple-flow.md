...
* **Vendor invoice: optional to _complete_ (Story 3 setting), but required to _receive_** on any receive surface (Bulk Receive / Accept Delivery), along with vendor + part number for vendor-missing / no-PN.
...
* **Vendor Missing** — flag on a PO that holds a part with no vendor; excluded from QuickBooks until vendor + part number are provided. _(No separate "dummy PO".)_
...
### Story 1: Work Order Settings (Simple Flow) — [SV-7696](https://shopview.atlassian.net/browse/SV-7696)
...
_New (introduced by this feature):_

* **S1-R1 — Auto-approve lines.** On → every line is approved the moment it's added (no approval step). Off → manual approval, as today. _Must actually drive approval._ Default **OFF**. _Interaction: completion requires **all lines approved** — with auto-approve ON, manually unapproving a line blocks completion (via the existing "approve the line to complete the work order" error) until re-approved. See Stories 3/4/16._
...
_Existing (already in the app — surfaced here, reflecting current values; not changed by this feature):_
...
**UI/UX.** [Simple Flow Design — Settings](https://claude.ai/design/p/39d552c4-db76-4c3c-8dcd-c6ec7dc2b5c5?file=Simple+Flow+Design.html) · [QA — Work Order Settings](https://sv7301.qa.shopview.com/administration/settings)

---

### ~~Story 2: Simple Completion — No-PO (Skip) Flow —~~ [~~SV-7697~~](https://shopview.atlassian.net/browse/SV-7697)

**~~Summary.~~** ~~In a shop with PO creation off, complete a work order in a single confirm and go straight to an invoice-ready draft. _(Review-OFF path; when Require review is on, see Story 16.)_~~
...
**~~UI/UX. ~~**[~~Simple Flow Design — completion flow~~](https://claude.ai/design/p/39d552c4-db76-4c3c-8dcd-c6ec7dc2b5c5?file=Simple+Flow+Design.html) ~~·~~ [~~QA — Work Order~~](https://sv7301.qa.shopview.com/workorders)

---

### Story 3: Simple Completion — PO On + Optional Vendor Invoice — [SV-7698](https://shopview.atlassian.net/browse/SV-7698)

**Summary.** For shops that create POs but don't require invoices upfront: complete the work order from one place — order/create POs in the background, pick parts, then either **receive now (all vendors at once)** or **finish and receive later**. _(Review-OFF path; review on → Story 16.)_
...
### Story 4: Simple Completion — PO On + Required Vendor Invoice — [SV-7699](https://shopview.atlassian.net/browse/SV-7699)

**Summary.** For shops that require vendor invoices: same one-place completion as Story 3, but the work order **cannot be completed until all parts are received** (invoice number captured). _(Review-OFF path; review on → Story 16.)_
...
### Story 5: Add a Vendorless / No-Part-Number Part — [SV-7700](https://shopview.atlassian.net/browse/SV-7700)
...
**UI/UX.** [Simple Flow Design](https://claude.ai/design/p/39d552c4-db76-4c3c-8dcd-c6ec7dc2b5c5?file=Simple+Flow+Design.html) · [QA — Work Order Lines](https://sv7301.qa.shopview.com/workorders)

---

### Story 6: Vendorless Part on the WO PO — "Vendor Missing" + QB Flag — [SV-7701](https://shopview.atlassian.net/browse/SV-7701)
...
**UI/UX.** [Simple Flow Design](https://claude.ai/design/p/39d552c4-db76-4c3c-8dcd-c6ec7dc2b5c5?file=Simple+Flow+Design.html) · [QA — Purchase Orders](https://sv7301.qa.shopview.com/parts/orders)

---

### Story 7: PO Multi-Select + "Receive Selected" — [SV-7702](https://shopview.atlassian.net/browse/SV-7702)
...
### Story 8: PO Bulk Receive Page — [SV-7703](https://shopview.atlassian.net/browse/SV-7703)
...
**UI/UX.** [Simple Flow Design — PO Bulk Receive](https://claude.ai/design/p/39d552c4-db76-4c3c-8dcd-c6ec7dc2b5c5?file=Simple+Flow+Design.html) · [QA — PO Bulk Receive](https://sv7301.qa.shopview.com/parts/bulk-receive)

---

### Story 9: Per-Vendor "Apply Invoice to Selected POs" — [SV-7704](https://shopview.atlassian.net/browse/SV-7704)
...
### Story 10: Inline Part-Number Fix → First-Class Inventory Part — [SV-7705](https://shopview.atlassian.net/browse/SV-7705)
...
**UI/UX.** [Simple Flow Design](https://claude.ai/design/p/39d552c4-db76-4c3c-8dcd-c6ec7dc2b5c5?file=Simple+Flow+Design.html) · [QA — PO Bulk Receive](https://sv7301.qa.shopview.com/parts/bulk-receive)

---

### Story 11: Receive Button on Work-Order-Originated POs — [SV-7706](https://shopview.atlassian.net/browse/SV-7706)
...
### Story 12: Accept Delivery — multi-vendor (existing) + Simple-Flow parts support — [SV-7707](https://shopview.atlassian.net/browse/SV-7707)
...
**UI/UX.** [Simple Flow Design — Accept Delivery](https://claude.ai/design/p/39d552c4-db76-4c3c-8dcd-c6ec7dc2b5c5?file=Simple+Flow+Design.html) · [QA — Accept Delivery](https://sv7301.qa.shopview.com/parts/orders)

---

### Story 13: Assign Vendor + Merge / Keep-Separate — [SV-7708](https://shopview.atlassian.net/browse/SV-7708)
...
### Story 14: "Waiting on Parts" Column + Receive Shortcut — [SV-7709](https://shopview.atlassian.net/browse/SV-7709)
...
**UI/UX.** [Simple Flow Design](https://claude.ai/design/p/39d552c4-db76-4c3c-8dcd-c6ec7dc2b5c5?file=Simple+Flow+Design.html) · [QA — Work Orders List](https://sv7301.qa.shopview.com/workorders)

---

### Story 15: UX Refinements — Labels, Centralized Required Fields, Close Confirmation — [SV-7710](https://shopview.atlassian.net/browse/SV-7710)
...
**UI/UX.** [Simple Flow Design](https://claude.ai/design/p/39d552c4-db76-4c3c-8dcd-c6ec7dc2b5c5?file=Simple+Flow+Design.html) · [QA — Work Orders List](https://sv7301.qa.shopview.com/workorders) — ⚠️ close-confirm Figma still to be added.

---

### Story 16: Simple Completion — Review ON (review gate + sign-off) — [SV-7870](https://shopview.atlassian.net/browse/SV-7870)
...
### Story 17: Tech Story Flow — per-line entry + completion gate — [SV-7876](https://shopview.atlassian.net/browse/SV-7876)
