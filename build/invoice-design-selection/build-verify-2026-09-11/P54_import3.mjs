...
const R={}; const save=()=>fs.writeFileSync(`${DIR}/evidence/P54.json`, JSON.stringify(R,null,1));
...
const row=(item,title,part,qty,rate,total,tax)=>
 `${LOC},${CUSTOMER},,2015,Freightliner,Cascadia,ZZAUTOTEST-1,Truck,120000,,ZZAUTOTEST-IMP-003,09/11/2026,ZZAUTOTEST,,${item},${title},Imported invoice design check,,${part},${part?'ZZAUTOTEST Part':''},${qty},${rate},${total},${tax}`;
...
const p=`${DIR}/evidence/zzautotest-import3.csv`; fs.writeFileSync(p,csv);
...
await page.screenshot({path:`${DIR}/evidence/P54-after-import.png`, fullPage:true});
