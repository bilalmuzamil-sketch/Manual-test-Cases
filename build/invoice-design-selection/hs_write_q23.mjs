...
const OKLOG = `${DIR}/REPAIRED-q23.jsonl`;
const BADLOG = `${DIR}/FAILED-q23.jsonl`;
...
const data = JSON.parse(fs.readFileSync(`${DIR}/intended-blocks-q23.json`, 'utf8'));
const targets = JSON.parse(fs.readFileSync(`${DIR}/targets-q23.json`, 'utf8')).map(String);
