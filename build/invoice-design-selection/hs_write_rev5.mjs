...
const DIR = '/home/user/Manual-test-Cases/build/invoice-design-selection';
const OKLOG = `${DIR}/REPAIRED-rev5.jsonl`;
const BADLOG = `${DIR}/FAILED-rev5.jsonl`;
...
const data = JSON.parse(fs.readFileSync(`${DIR}/intended-blocks-rev5.json`, 'utf8'));
const targets = JSON.parse(fs.readFileSync(`${DIR}/targets-rev5.json`, 'utf8')).map(String);
