// Schedule QA branch sv8685 — browser driver on the ONE established session.
...
const CACHE='/tmp/assetcache-8685'; fs.mkdirSync(CACHE,{recursive:true});
...
async function boot(opts={}){
  ...
  const seed=JSON.parse(fs.readFileSync('/tmp/sch-panel/seed.json','utf8'));
