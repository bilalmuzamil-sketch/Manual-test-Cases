// SUITE 6617 (Printer Friendly Work Orders) -- rewrite preconditions, steps and Expected Results
...
const DIR = process.env.DIR || '/home/user/Manual-test-Cases/build/printer-friendly-wo/build-verify-2026-09-01/write-2026-09-01';
...
const RUNFLAG = process.env.RUNFLAG || '/tmp/pfwrite/RUNNING';
...
fs.mkdirSync('/tmp/pfwrite', { recursive: true });
