#!/usr/bin/env python3
"""Generate the TestRail import for Printer Friendly Work Orders (epic SV-9383, PRD v8).
...
OUT_CSV = os.path.join(ROOT, "testrail-import", "Printer-Friendly-Work-Orders_testrail-import.csv")
OUT_XLSX = os.path.join(ROOT, "testrail-import", "Printer-Friendly-Work-Orders_testrail-import.xlsx")
...
def main():
    ...
    try:
        ...
        wb = Workbook(); ws = wb.active; ws.title = "Printer Friendly WO"
        ws.append(HEADER)
