#!/usr/bin/env python3
"""Generate the TestRail import for Global Search V1 Regression (epic SV-9160).
...
CASES = sorted(glob.glob(os.path.join(ROOT, "cases", "regression-cases.json")))
OUT_CSV = os.path.join(ROOT, "testrail-import", "Global-Search-V1-Regression_testrail-import.csv")
OUT_XLSX = os.path.join(ROOT, "testrail-import", "Global-Search-V1-Regression_testrail-import.xlsx")
...
def main():
    ...
    try:
        ...
        wb = Workbook(); ws = wb.active; ws.title = "GS V1 Regression"
        ws.append(HEADER)
