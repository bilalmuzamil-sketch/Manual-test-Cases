...
| 2 | ☐ | **SBC Print removed** (P25, 31:14) | SBC Story 16 deleted / S14-R1 menu no longer lists "Print" | SBC-EXP-01 C30159, SBC-EXP-14 C30172, SBC-EXP-13 C30171 (Retire-Proposed — delete only after ratification + authorization) |
| 3 | ☐ | **SBC compressed (summary) download** (P21, 32:10–33:03 + 48:39) | SBC Stories 14/15 gain a Summary/Compressed download option | SBC-EXP-16 (new — no C-ID yet; delete-to-recover if never ratified) |
