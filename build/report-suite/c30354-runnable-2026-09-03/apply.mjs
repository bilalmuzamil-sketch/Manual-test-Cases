...
const DIR = '/home/user/Manual-test-Cases/build/report-suite/c30354-runnable-2026-09-03';
const REPAIRED = `${DIR}/REPAIRED.jsonl`;
const FAILED = `${DIR}/FAILED.jsonl`;
const AUTOMATED_OK = new Set(['30354']);   // QA-lead go-ahead for C30354, 2026-09-03
