# Parts Velocity Report — COMPLETE spec (verbatim-structured)
...
> - **Spec doc metadata (from the export header):** Epic TBD · Owner TBD · Status = In review — 2026-07-16 · Branch TBD · latest change-log entry 2026-07-16 (server-side data model per Milan's review). Export filename `PartsVelocityReport_1.doc` (revision `_1`).
