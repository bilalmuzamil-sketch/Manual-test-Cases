...
**✅ RESOLVED 2026-08-20 — C30162 (Sales By Customer) and C30287 (Sales By Representative) are
confirmed ALREADY-OK in the `<br>` interim form (render-verified multi-line, marker/provenance
intact, no run-on). Removed from the reflow list; no further action needed on these two.**
