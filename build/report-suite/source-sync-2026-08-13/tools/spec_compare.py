...
PAIRS = {
    "Sales By Customer":       ("Sales-By-Customer", 17, 20),
    "Sales By Representative": ("Sales-By-Representative", 18, 22),
    "Parts Velocity":          ("Parts-Velocity", 6, 8),
    "Technician Utilization":  ("Technician-Utilization", 7, 9),
    "Work In Progress":        ("Work-In-Progress", 11, 15),
    "Inventory Value":         ("Inventory-Value", 5, 6),
}
