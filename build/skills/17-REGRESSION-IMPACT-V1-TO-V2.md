...
charter; it does not restate it.** Rule text: `build/rules/RULES-61-ONWARD.md`.
...
**Standing Rule 96** is this skill's rule. Read it in full in `build/rules/RULES-61-ONWARD.md` before
