...
| 2 | `02-SOURCE-CHECK.md` | **§1 first — but ASK BEFORE RUNNING IT AND WAIT** (Rule 81's gate, re-confirmed by the QA lead 2026-09-03: *"I will keep this rule for this Build verification session."*). Name the need, give the last-done DATE + spec version, ask with-or-without, wait. He raised what "current" means when he says yes — the whole Rule 57 list, spec · epic + ALL child stories · design · PO answers — but **whether to run it is his call, per session** |
