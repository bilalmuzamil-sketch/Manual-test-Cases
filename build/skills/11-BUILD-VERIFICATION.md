...
| 2 | `02-SOURCE-CHECK.md` | **§1 FIRST, AND WITHOUT ASKING** — QA lead 2026-09-03: *"everytime I ask you to build verify anything, the first thing you must ALWAYS do is to get the latest from all the sources, and then proceed with the task."* Pull spec · epic + stories · design · PO answers LIVE, fold in the deltas (43), THEN touch the build. The 2026-08-20 ask-and-wait gate is **superseded** for this lane (Rule 81) |
