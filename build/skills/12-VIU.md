...
| 2 | `02-SOURCE-CHECK.md` | **First — but ASK AND WAIT before running it** (Rule 81's gate, re-confirmed 2026-09-03): last-done date + version, with-or-without, wait. Once authorised, refresh the whole Rule 57 list and fold in the deltas; Rule 59 re-reads it again immediately before the writes begin |
