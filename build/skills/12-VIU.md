...
| 2 | `02-SOURCE-CHECK.md` | **FIRST, AND WITHOUT ASKING** (QA lead 2026-09-03 — the 2026-08-20 ask-and-wait gate is superseded for a build-verify / VIU order, Rule 81): pull every source LIVE and fold in the deltas before any live work; Rule 59 re-reads it again immediately before the writes begin |
