...
| **2026-08-17** | *"1 is correct"* | New **MANUAL** cases via `add_case` carry **`custom_atmstatus: 1`**; `3` = Automated is reserved (e.g. Vladimir Tomovic's); `custom_automation_type: 0` unchanged. All three Fabian-review passes (Schedule / Report Suite / Filters) used `1` — **no future pass may revert to `3`** (core §3.1). |
