...
doc={"type":"doc","version":1,"content":[
 ...
 table,
 heading("Evidence"),
 *media(B+"/EX1-cap-notice-annotated.png",
    "The 50-value cap on Inventory Value. Picking vendors and categories one by one reaches 50 combined; the remaining unchecked options lock and the inline notice \"50 selected (max 50 across all filters)\" appears."),
