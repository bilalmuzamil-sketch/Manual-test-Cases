...
- **AFTERWARDS you MAY and SHOULD consult ANY document the task in hand needs** —
  ...
  `RULES-61-98.md`, a past findings or audit file. **No document is off-limits to you.**
...
`RULES-21-40.md` · `RULES-41-60.md` · `RULES-61-98.md`**, and **that is where you read the rule you
...
> below, which carries all twelve clauses in full. Full texts: `build/rules/RULES-61-98.md`.

---

## SEARCH BEFORE YOU GIVE UP (mandatory — Rule 97)

**This section is MANDATORY in every handoff.** Full rule text: `build/rules/RULES-61-98.md` (Rule 97,
...
`build/rules/RULES-61-98.md` (Rule 95, tying Rules 12, 50, 75, 76, 77, 78, 79, 80, 86, 88, 90). The
