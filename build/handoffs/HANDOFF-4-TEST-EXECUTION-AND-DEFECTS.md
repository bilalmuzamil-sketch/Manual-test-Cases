...
**Rule texts:** `build/rules/RULES-01-20.md` · `RULES-21-40.md` · `RULES-41-60.md` · `RULES-61-94.md`.
...
- **Rule 90 budget:** main **15 %** · each lane **25 %** · **10 % reserve**. **Report your spend with
  your work.** At **50 %** of your own budget, compare spend against progress and **STOP AND REPORT**
  if spend is outpacing it. **Never touch the reserve** without the QA lead.
