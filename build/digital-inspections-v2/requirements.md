# Digital Inspections V2 — Requirements (ingested)

**Spec:** Confluence 768507905, **version 18** (created 2026-08-10), read 2026-08-21.
**Epic:** SV-8181 · **PO:** Milos Vasic · **QA env:** sv8181.qa.shopview.com (present but DO NOT TOUCH per QA lead).
**Design:** Claude 'Digital Inspections V2' (0c2be389) + the attached DVI-V2 build-spec/user-stories/design-brief bundle.
**In scope (14 stories):** S1,S17,S8,S11 (capture) · S2,S3,S4,S6,S7,S15 (build) · S5 (history) · S12,S13,S14 (authoring/output).
**Out of scope:** S9 conditional follow-ups + S10 instruction acknowledgement (removed 2026-08-20); the Line Builder from a WO with no inspection (S15-N5, epic SV-9405/S16 — not an inspection flow).
