#!/usr/bin/env python3
"""Generate the TestRail import for Digital Inspections V2 (epic SV-8218, spec v38).
...
ROOT = "build/digital-inspections-v2"
CASES = sorted(glob.glob(os.path.join(ROOT, "cases", "cases-*.json")))
OUT_CSV = os.path.join(ROOT, "testrail-import", "Digital-Inspections-V2_testrail-import.csv")
OUT_XLSX = os.path.join(ROOT, "testrail-import", "Digital-Inspections-V2_testrail-import.xlsx")
...
def main():
    ...
    try:
        ...
        wb = Workbook(); ws = wb.active; ws.title = "Digital Inspections V2"
        ws.append(HEADER)
