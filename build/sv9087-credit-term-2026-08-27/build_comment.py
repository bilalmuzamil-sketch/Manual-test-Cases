...
C+=img("EX-A-invoice-date-before-after.png","Check A — customer credit term seeded “NET 30” (the mis-spelled CSV value). Changing the invoice date to 09/15/2026 re-renders the invoice with no blank page and no error boundary, and the due date recomputes to Oct 15, 2026 (+30). Verified with no crash across net 30 / Net30 / Net 30 Days / Due On Receipt / CREDIT HOLD / Prepaid.")
...
C.append(bullet(
 ...
 [tb("A: "),t("WO S9087-15890, term “NET 30”. Draft due date Aug 27 → Sep 26; invoice date → 09/15/2026 gives due Oct 15, 2026. No error boundary; term sweep across 7 spellings produced 0 blanks / 0 errors.")],
