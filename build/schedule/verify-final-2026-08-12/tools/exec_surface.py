...
OUT = "/home/user/Manual-test-Cases/build/schedule/verify-final-2026-08-12/evidence/surface-oplog.json"
payloads = json.load(open("/tmp/sched/surface-payloads.json"))
...
for n, cid in enumerate(order, 1):
    ...
    rec = {"op": n, "cid": int(cid), "was": "see build_surface_payloads.py",
