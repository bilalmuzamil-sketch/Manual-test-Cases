...
//
// Cookies come from /tmp/qa-cookies/schedule-tech-cookie-header.txt and are never
...
const OUT = '/home/user/Manual-test-Cases/build/schedule/verify-final-2026-08-12/evidence';
const CK = fs.readFileSync('/tmp/qa-cookies/schedule-tech-cookie-header.txt', 'utf8').trim();
...
function buildUser(fe) {
  return {
    data: {
      details: {
        email: 'bilal.muzamil+schedule@shopview.com',
        staff_id: '4de28d50-586f-4570-be10-a5808502be03',   // Bilal Muzamil, role Technician - READ LIVE from GET /api/staff
        clockable: true,
      ...
      name: 'Bilal Muzamil',
      email: 'bilal.muzamil+schedule@shopview.com',
      user_id: null,   // the staff directory returns user_id null for this account; NOT the admin's, which would corrupt the identity
