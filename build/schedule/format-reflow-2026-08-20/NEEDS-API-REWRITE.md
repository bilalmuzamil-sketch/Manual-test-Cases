...
- [C29969](https://shopview.testrail.io/index.php?/cases/view/29969) — field(s) preconds/steps store line breaks as raw \n inside <p> with NO <br>; the "." reflow would collapse them into a run-on line. Rewrite via API into <br> form first, then reflow. (atm=1)
- [C29991](https://shopview.testrail.io/index.php?/cases/view/29991) — field(s) steps store line breaks as raw \n inside <p> with NO <br>; the "." reflow would collapse them into a run-on line. Rewrite via API into <br> form first, then reflow. (atm=1)
- [C29997](https://shopview.testrail.io/index.php?/cases/view/29997) — field(s) steps store line breaks as raw \n inside <p> with NO <br>; the "." reflow would collapse them into a run-on line. Rewrite via API into <br> form first, then reflow. (atm=1)
- [C30008](https://shopview.testrail.io/index.php?/cases/view/30008) — field(s) preconds/steps store line breaks as raw \n inside <p> with NO <br>; the "." reflow would collapse them into a run-on line. Rewrite via API into <br> form first, then reflow. (atm=1)
- [C30016](https://shopview.testrail.io/index.php?/cases/view/30016) — field(s) preconds/steps store line breaks as raw \n inside <p> with NO <br>; the "." reflow would collapse them into a run-on line. Rewrite via API into <br> form first, then reflow. (atm=1)
- [C30031](https://shopview.testrail.io/index.php?/cases/view/30031) — field(s) steps store line breaks as raw \n inside <p> with NO <br>; the "." reflow would collapse them into a run-on line. Rewrite via API into <br> form first, then reflow. (atm=1)
- [C30032](https://shopview.testrail.io/index.php?/cases/view/30032) — field(s) steps store line breaks as raw \n inside <p> with NO <br>; the "." reflow would collapse them into a run-on line. Rewrite via API into <br> form first, then reflow. (atm=1)
- [C30034](https://shopview.testrail.io/index.php?/cases/view/30034) — field(s) preconds/steps store line breaks as raw \n inside <p> with NO <br>; the "." reflow would collapse them into a run-on line. Rewrite via API into <br> form first, then reflow. (atm=1)
