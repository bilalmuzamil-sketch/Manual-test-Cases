...
export async function shot(page,name){await page.screenshot({path:'/tmp/fv/shots/'+name+'.png'});}
export function save(name,obj){fs.writeFileSync('/tmp/fv/'+name+'.json',JSON.stringify(obj,null,1));}
