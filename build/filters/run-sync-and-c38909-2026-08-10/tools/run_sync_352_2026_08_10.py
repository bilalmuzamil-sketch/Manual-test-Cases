...
# 2026-08-10 SCOPED COPY: authorisation covers RUN 352 (Filters) ONLY.
# Runs 359 (Report Suite) and 357 (Schedule) are deliberately REMOVED from SCOPE so this
# script cannot read or write them — live workers are on both of those projects today.
SCOPE = [(352, 'Filters', 4110)]
