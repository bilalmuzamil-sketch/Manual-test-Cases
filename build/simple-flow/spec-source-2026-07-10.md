<!--
PROVENANCE
Source file : b91efa39-SimpleMode_StreamlinedWorkOrderCompletionBulkReceiving_1.doc
Upload dir  : /root/.claude/uploads/dd1d42ba-2c47-5229-9b17-b8f94e3eb99a/
Uploaded    : 2026-07-10 (Confluence "Exported From Confluence" MHTML export;
              Message Date header: Fri, 10 Jul 2026 16:28:16 +0000)
...
Parsed on   : 2026-07-10 (Simple Flow project ONLY; PO = Milos; Epic SV-7301)
Doc version : "Draft for build — V2.4" (version STRING unchanged; change-log last
              row still 2026-07-08). CONTENT is a SILENT REVISION newer than the
              prior 991acdb4 (Jul-9) V2.4 upload — see spec-diff-2026-07-10.md.
Note        : This is a READABLE SNAPSHOT for traceability only. Authoritative
              ...
              artifacts from the HTML parse are cosmetic.
-->

# Simple Mode — Streamlined WO Completion & Bulk Receiving — SOURCE SNAPSHOT (2026-07-10)
...
Context. Settings → Work Order settings; org-wide; owner/admin only. Drop the POC'soperatingMode field — do not build a Full/Simple selector.
