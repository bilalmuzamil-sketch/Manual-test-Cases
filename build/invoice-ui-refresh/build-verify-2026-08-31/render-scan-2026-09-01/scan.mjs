...
// Scope here: all 119 Invoice UI Refresh cases. WHY IT MATTERS: another session edited 42 of them
// and an API write leaves a field in the plain 'markdown' container, which ESCAPES block HTML so
// the tester literally reads <ol><li><p>. Only a UI save flips it to 'markdown fr-view'.
...
const DIR = '/home/user/Manual-test-Cases/build/invoice-ui-refresh/build-verify-2026-08-31/render-scan-2026-09-01';
