...
## Checklist (from the dev's QA handoff) and results

| # | Check | Result |
|---|---|---|
| A | Two POs, one invoice — each row its own share ($100 / $200), not $300 twice | PASS — rows $100.00 + $200.00, Totals selected $300.00 (before fix: $600.00). EX-A |
| B (uneven tax) | Tax 10.01 over a $100/$200 pair — shares total exactly, larger PO larger share | PASS — 3.34 + 6.67 = 10.01; PO rows $103.34 + $206.67 = $310.01. EX-B |
| B (zero tax) | Tax empty — both rows no tax, totals match part costs | PASS — $100 + $200, no tax (INV-ZERO) |
| C1 | Single-PO full receive with tax — recorded total matches screen, tax matches | PASS — 2×$100 + $15 tax = $215.00 recorded (INV-SINGLE) |
| C2 | Single-PO partial receive (1 of 2) — total reflects only qty received | PASS — 1×$100 = $100.00 recorded (INV-P) |
