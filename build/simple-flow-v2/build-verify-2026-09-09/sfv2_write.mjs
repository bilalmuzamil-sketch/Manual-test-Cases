...
const DIR = '/home/user/Manual-test-Cases/build/simple-flow-v2/build-verify-2026-09-09';
const OKLOG = `${DIR}/REPAIRED-hs.jsonl`;
const BADLOG = `${DIR}/FAILED-hs.jsonl`;
const AUTOMATED_OK = new Set(['44557','44561','44575','44583','44587','44604','44605']);  // Simple Flow V2 authorised (QA lead 2026-09-09, Rule 65/71)
