#!/usr/bin/env python3
"""Generate the TestRail import for Simple Flow V2 (epic SV-8683, spec v21).
...
ROOT = "build/simple-flow-v2"
CASES = sorted(glob.glob(os.path.join(ROOT, "cases", "cases-*.json")))
OUT_CSV = os.path.join(ROOT, "testrail-import", "Simple-Flow-V2_testrail-import.csv")
OUT_XLSX = os.path.join(ROOT, "testrail-import", "Simple-Flow-V2_testrail-import.xlsx")
...
def main():
    ...
    try:
        ...
        wb = Workbook(); ws = wb.active; ws.title = "Simple Flow V2"
        ws.append(HEADER)
