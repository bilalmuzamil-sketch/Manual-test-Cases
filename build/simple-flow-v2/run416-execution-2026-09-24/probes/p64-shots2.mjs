...
const { browser, page } = await bootProdLogin('/workorders', { settle: 12000, viewport:{width:1000,height:700}, deviceScaleFactor: 2 });
page.setDefaultTimeout(30000);
// the bulk bar, on a work order with several lines
...
await page.goto('https://app.shopview.com/parts/orders',{waitUntil:'domcontentloaded'}); await page.waitForTimeout(12000);
await page.screenshot({ path: `${SH}/purchase-orders.png` });
console.log('captured purchase-orders');
await openWo(page, '4560a837-ee20-46e5-a62c-c6a4892fc85d'); await page.waitForTimeout(6000);
