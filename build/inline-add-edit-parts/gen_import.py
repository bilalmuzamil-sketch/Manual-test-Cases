#!/usr/bin/env python3
"""Generate the TestRail import for Inline Add and Edit Parts (epic SV-9315, PRD v13).
...
OUT_CSV = os.path.join(ROOT, "testrail-import", "Inline-Add-and-Edit-Parts_testrail-import.csv")
OUT_XLSX = os.path.join(ROOT, "testrail-import", "Inline-Add-and-Edit-Parts_testrail-import.xlsx")
...
def main():
    ...
    try:
        ...
        wb = Workbook(); ws = wb.active; ws.title = "Inline Add and Edit Parts"
        ws.append(HEADER)
