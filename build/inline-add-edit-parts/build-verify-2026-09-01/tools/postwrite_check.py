#!/usr/bin/env python3
"""THE REQUIRED POST-WRITE CHECKS for suite 6597, read LIVE from TestRail.
...
SECS = [6755, 6756, 6757, 6758, 6759, 6760, 6771]
cases = []
for s in SECS:
...
for c in cases:
    ...
    should = verdict in ('PASS', 'FAIL', 'PARTIAL')
