...
V = {
    ...
    45234: (None, None,
            ''),
    45235: ('PARTIAL', 'S5-negative-bin',
            'the already-negative bin is real and visible: the typeahead card for TP-12-1013-CH reads "Inventory Qty: 3 ea LGRACK -1 D1F 3" and the picker lists "LGRACK -1" alongside "check D1F Default 3", and nothing blocked. What is NOT yet confirmed is the ERROR STYLING on that row inside the Bin Locations modal - as a Full View user "Split across bins…" opens the New Part Request modal, which listed only the allocated bin. Being re-read as the technician, where the Bin Locations modal lives'),
