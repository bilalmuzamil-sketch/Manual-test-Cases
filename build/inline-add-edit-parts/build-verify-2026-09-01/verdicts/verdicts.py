...
V = {
    ...
    45221: (None, None,
            ''),
    45222: ('PASS', 'B1-cards',
            'result cards read "Inventory Qty: 7 EA" then the per-bin chip "PB1 7" - total first, then per-bin quantity. The "+ N" collapse chip and the "Not stocked" card have no data on this branch to show them (INL-2)'),
    ...
    45226: ('PASS', 'B2-picker',
            'the chip opens a picker reading "check PB1 Default 7" then "Split across bins…" - the check on the current selection, the Default badge, the on-hand quantity and the split action'),
    45227: (None, None,
            ''),
