<!-- SNAPSHOT: text extraction of the NEW Fees & Discounts V1 spec doc.
Source upload: /root/.claude/uploads/dd1d42ba-2c47-5229-9b17-b8f94e3eb99a/49f38748-FeesDiscountsV1_2.doc
(Confluence MHTML export; successor to FeesDiscountsV1_1.doc which our requirements.md baseline was built from).
Ingested 2026-07-10 (QA-lead input date). NOTE: the doc's newest Change Log entry is dated 2026-07-12
(@chris / @claude, "Resolves Sasha's 2026-07-12 review comments"); the epic status line reads
"SV-7387 - Fees & Discounts In Progress" (was "Open" in V1_1). No literal "v73" version marker exists
in the document; version is tracked only by the Change Log (§8). HTML/formatting artifacts were stripped;
some mojibake remains on glyphs (e.g. the "more"/⌄ menu char, the "↳" indent arrow). This is a verbatim-as-possible
text snapshot for diffing, NOT the authoritative spec — the .doc upload is authoritative. -->

# Fees & Discounts V1 — spec text snapshot (from FeesDiscountsV1_2.doc, ingested 2026-07-10)
...
Epic
|
SV-7387 - Fees & Discounts In Progress
|
Owner
|
TBD
...
Below every Taxable control — the Add / Edit fee-or-discount dialog (S2-R26) and the Processing Fee dialog (S8-R11) — this exact text shows: Tax treatment varies by jurisdiction — confirm your local requirements before saving. It is a plain advisory to the shop; it is not a UI instruction and not a legal-compliance statement.
6. Requirements
