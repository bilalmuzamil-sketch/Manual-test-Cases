...
Requires **See Financial Data**. **Delete does NOT require Manage AP/AR**
(ruling updated 2026-07-16, following the newer tickets SV-7812/7913 — the old
AP/AR dependency for reversal/payment-delete was dropped). Note: Manage AP/AR
still controls the consolidated AP/AR *tabs* (Unpaid Invoices / Payments /
Credits) on customer & vendor pages — that's separate from being able to
reverse/delete from a work order or part sale.
...
- **Delete:** delete payments (including customer payments), void
  transactions, delete a part-sale return — gated by Invoicing: Delete alone.
  (Invoice REVERSAL is NOT here — it moved to Work Orders: Delete / Part Sales:
  Delete.)
...
| Delete a payment | Invoicing: Delete (does NOT need Manage AP/AR — updated 2026-07-16) |
...
- **Reverse a PART SALE invoice** = Part Sales: Delete (NOT Work Orders: Delete
  ...
  (SV-8237/8238).
- **Delete a payment** (customer or vendor) = Invoicing & Payments: Delete
  alone — it does NOT require Manage AP/AR (ruling updated 2026-07-16, following
  newer SV-7812/7913; the earlier AP/AR dependency was dropped). Vendor payment
  delete is Invoicing: Delete, not Vendor & Order Delete (SV-8167). Manage AP/AR
  still governs the consolidated AP/AR tabs' visibility (SV-8100), which is a
  separate concern.
...
- **Notes: can WO View edit OTHER people's notes? (SV-8135 vs SV-8003/8319).**
  ...
  wrong.
(Two earlier conflicts here were resolved by the user on 2026-07-16 and moved
into the main rules: (a) **Office cannot create invoices but can take payments**
— confirmed, the Create-Invoice button is disabled for Office regardless of
Invoicing CRUD; (b) **reversing an invoice / deleting a payment does NOT require
Manage AP/AR** — gated by Invoicing: Delete alone, per "follow the newer
ruling.")
